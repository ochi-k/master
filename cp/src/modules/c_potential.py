...
class Item(object):
    ...
    @property
    def vx(self):  # getter/setter of Vx component
        return self._Vx

    @property
    def vy(self):  # getter/setter of Vy component
        return self._Vy

    @property
    def x(self):  # getter/setter of x component
        return self._x

    @property
    def y(self):  # getter/setter of y component
        return self._y
